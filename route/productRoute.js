...
productRoute.delete('/delete-product/:productId',verifyAccessToken,adminAuth,productController.deleteProduct)
productRoute.patch('/update-product/:productId',verifyAccessToken,adminAuth,productController.updateProduct)
